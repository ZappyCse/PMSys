<%-- 
    ...
    Created on : 17 Oct, 2016, 10:53:05 AM
    Author     : Arun
--%>
...
<body <%if(flag1){%>onload="FillAddress()"<%}%>>
    <form method="POST" action="MainServlet">
        <center> <h3> Emp ID <input type = "text" value="<%=faculty.getFacultyId() %>" id = "empId" name="empId" readonly="readonly"/> </h3> </center>
<hr />
<h2>Personal Details </h2>
<div style="padding:20px; border:2px ridge black;border-radius:35px">
...
<td> <input type = "email" id = "secmail" name="secmail" value="<%=flag?(personalInfo.getSecMailId()==null?"":personalInfo.getSecMailId()):""%>"/> </td>
</tr>
</table>
</div>
<h2>Address</h2>
